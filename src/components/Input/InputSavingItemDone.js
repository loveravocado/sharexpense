...
export default function InputSavingItemDone() {
  return (
    <>
    <Header />
    <div className='whiteshadow'></div>
    <img className= "input_saving_icon_contents done_saving" src= {icon_saving_white} alt="home" />
        ...
        <div className='inputsavingitemdown'><p>保存されました</p></div>
